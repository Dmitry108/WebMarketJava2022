...
import ru.home.aglar.market.di.xml.Cart;
import ru.home.aglar.market.di.xml.ProductRepository;

public class MarketAppXml {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("ru/home/aglar/market/main/config.xml");
