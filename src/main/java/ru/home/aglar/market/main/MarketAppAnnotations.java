...
import ru.home.aglar.market.di.annotations.Cart;
import ru.home.aglar.market.di.annotations.ProductRepository;

public class MarketAppAnnotations {
    public static void main(String[] args) {
        ApplicationContext context = new AnnotationConfigApplicationContext("ru.home.aglar.market.di.annotations");
